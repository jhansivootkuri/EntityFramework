...
namespace Microsoft.EntityFrameworkCore.Tests
{
    public class ModelBuilderNonGenericTest : ModelBuilderTest
    {
            ...
            where TRelatedEntity : class
        {
            ...
            public override TestReferenceOwnershipBuilder<TEntity, TRelatedEntity> HasAnnotation(string annotation, object value)
                => Wrap<TEntity, TRelatedEntity>(ReferenceOwnershipBuilder.HasAnnotation(annotation, value));

            public override TestReferenceOwnershipBuilder<TEntity, TRelatedEntity> HasOwnershipAnnotation(string annotation, object value)
                => Wrap<TEntity, TRelatedEntity>(ReferenceOwnershipBuilder.HasOwnershipAnnotation(annotation, value));
            ...
            public override TestReferenceOwnershipBuilder<TEntity, TRelatedEntity> Ignore(Expression<Func<TEntity, object>> propertyExpression)
            ...
            public override TestReferenceOwnershipBuilder<TRelatedEntity, TNewRelatedEntity> OwnsOne<TNewRelatedEntity>(
                ...
                => Wrap<TRelatedEntity, TNewRelatedEntity>(ReferenceOwnershipBuilder.OwnsOne(
                    typeof(TRelatedEntity), navigationExpression.GetPropertyAccess().Name));
            ...
            public override TestReferenceNavigationBuilder<TRelatedEntity, TNewRelatedEntity> HasOne<TNewRelatedEntity>(
                ...
                => new NonGenericTestReferenceNavigationBuilder<TRelatedEntity, TNewRelatedEntity>(
                    ReferenceOwnershipBuilder.HasOne(typeof(TRelatedEntity), navigationExpression?.GetPropertyAccess().Name));
            ...
            public override TestCollectionNavigationBuilder<TRelatedEntity, TNewRelatedEntity> HasMany<TNewRelatedEntity>(Expression<Func<TRelatedEntity, IEnumerable<TNewRelatedEntity>>> navigationExpression = null)
                => new NonGenericTestCollectionNavigationBuilder<TRelatedEntity, TNewRelatedEntity>(
                    ReferenceOwnershipBuilder.HasMany(typeof(TRelatedEntity), navigationExpression?.GetPropertyAccess().Name));

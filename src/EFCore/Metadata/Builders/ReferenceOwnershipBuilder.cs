...
namespace Microsoft.EntityFrameworkCore.Metadata.Builders
{
    ...
    public class ReferenceOwnershipBuilder : ReferenceReferenceBuilderBase, IInfrastructure<InternalEntityTypeBuilder>
    {
        ...
        public virtual ReferenceOwnershipBuilder HasOwnershipAnnotation([NotNull] string annotation, [NotNull] object value)
        {
        ...
        /// <param name="value"> The value to be stored in the annotation. </param>
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
        public virtual ReferenceOwnershipBuilder HasAnnotation([NotNull] string annotation, [NotNull] object value)
        {
            Check.NotEmpty(annotation, nameof(annotation));
            Check.NotNull(value, nameof(value));
        ...
        {
            var relationship = ownedType.Type == null

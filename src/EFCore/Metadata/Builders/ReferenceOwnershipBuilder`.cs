...
namespace Microsoft.EntityFrameworkCore.Metadata.Builders
{
        ...
        where TRelatedEntity : class
    {
        ...
        public new virtual ReferenceOwnershipBuilder<TEntity, TRelatedEntity> HasOwnershipAnnotation(
            [NotNull] string annotation, [NotNull] object value)
            => (ReferenceOwnershipBuilder<TEntity, TRelatedEntity>)base.HasAnnotation(annotation, value);
        ...
        /// <param name="value"> The value to be stored in the annotation. </param>
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
        public new virtual ReferenceOwnershipBuilder<TEntity, TRelatedEntity> HasAnnotation([NotNull] string annotation, [NotNull] object value)
            => (ReferenceOwnershipBuilder<TEntity, TRelatedEntity>)base.HasAnnotation(annotation, value);
        ...
        ///     (<c>blog => blog.Url</c>).
        /// </param>
        public virtual ReferenceOwnershipBuilder<TEntity, TRelatedEntity> Ignore([NotNull] Expression<Func<TEntity, object>> propertyExpression)
            => (ReferenceOwnershipBuilder<TEntity, TRelatedEntity>)base.Ignore(
        ...
        private ReferenceOwnershipBuilder<TRelatedEntity, TNewRelatedEntity> OwnsOneBuilder<TNewRelatedEntity>(PropertyInfo navigation)
            where TNewRelatedEntity : class
        {
            var relationship = RelatedEntityType.Builder.Owns(typeof(TNewRelatedEntity), navigation, ConfigurationSource.Explicit);
            ...
            where TNewRelatedEntity : class
        {
            ...
            return new ReferenceNavigationBuilder<TRelatedEntity, TNewRelatedEntity>(
                ...
                RelatedEntityType.Builder.Navigation(relatedEntityType.Builder, navigation, ConfigurationSource.Explicit,
                    setPrincipalEnd: RelatedEntityType == relatedEntityType));
        }
